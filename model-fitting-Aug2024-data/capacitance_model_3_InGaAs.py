...
C_6K = ax.scatter(V, Capacitance_6K*pF)
...
C_6K_model = ax.plot(V_fine, C_total(V_fine, fit_params[0][0], fit_params[0][1], fit_params[0][2]))
C_10K_model = ax.plot(V_fine, C_total(V_fine, fit_params[1][0], fit_params[1][1], fit_params[1][2]))
C_30K_model = ax.plot(V_fine, C_total(V_fine, fit_params[2][0], fit_params[2][1], fit_params[2][2]))
C_50K_model = ax.plot(V_fine, C_total(V_fine, fit_params[3][0], fit_params[3][1], fit_params[3][2]))
C_100K_model = ax.plot(V_fine, C_total(V_fine, fit_params[4][0], fit_params[4][1], fit_params[4][2]))
C_150K_model = ax.plot(V_fine, C_total(V_fine, fit_params[5][0], fit_params[5][1], fit_params[5][2]))
C_200K_model = ax.plot(V_fine, C_total(V_fine, fit_params[6][0], fit_params[6][1], fit_params[6][2]))
C_300K_model = ax.plot(V_fine, C_total(V_fine, fit_params[7][0], fit_params[7][1], fit_params[7][2]))

ax.legend(['6K', '30K', '50K', '150K', '200K', '300K'], loc='upper left')
