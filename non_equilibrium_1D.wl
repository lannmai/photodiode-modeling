...
Plot[currentDenP[xP,t]*10^3, {t,0,tMax}, 
PlotRange->All, AxesLabel->{"Time (s)", "Hole current density (mA/m^2)"}]
...
Plot[currentDenN[xN,t]*10^3, {t,0,tMax}, 
PlotRange->All, AxesLabel->{"Time (s)", "Electron current density (mA/m^2)"}]


Plot[(currentDenN[xN,t] + currentDenP[xP,t])*10^3, {t,0,tMax}, 
PlotRange->All, AxesLabel->{"Time (s)", "Current density (mA/m^2)"}]

maxCurrentDen = FindMaxValue[currentDenN[xN,t] + currentDenP[xP,t], {t,0}];

Plot[{(currentDenN[xN,t] + currentDenP[xP,t])/maxCurrentDen, 1+Sin[modFreq*t]}, {t,0,tMax}, 
